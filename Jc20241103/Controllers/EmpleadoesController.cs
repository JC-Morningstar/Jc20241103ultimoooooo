...
namespace Jc20241103.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(Jc20241103Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empleados != null ? 
                          ...
                          Problem("Entity set 'Jc20241103Context.Empleados'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Edad,Cargo,FechaContratacion")] Empleado empleado)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Jc20241103Context.Empleados'  is null.");
            }
            var empleado = await _context.Empleados.FindAsync(id);
            if (empleado != null)
            {
